...
- [ ] Перевести API на корректные HTTP методы (PUT/PATCH/DELETE). (created 2026-01-17)
- [ ] Добавить восстановление пароля по email. (created 2026-01-17)
- [ ] Реализовать отзыв всех активных refresh-токенов при смене/восстановлении пароля через версию токена. (created 2026-01-17)
- [ ] Добавить таблицу refresh_tokens и аудит последнего входа пользователя. (created 2026-01-17)
- [ ] Сохранить user agent/устройство/локацию при логине для модерации. (created 2026-01-17)
