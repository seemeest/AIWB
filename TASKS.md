...
- [x] Добавить редактирование товара/черновика без повторной модерации. (created 2026-01-17) (completed 2026-01-17: PATCH /api/products/{id} с обновлением данных и переиндексацией)
- [x] Добавить блок «Похожие товары» в карточке товара. (created 2026-01-17) (completed 2026-01-17: GET /api/products/{id}/similar через Elasticsearch)
- [x] Подготовить план декомпозиции монолита на микросервисы. (created 2026-01-17) (completed 2026-01-17: план фаз добавлен в PLAN.md)
- [x] Определить дизайн API Gateway и маршрутизацию публичного REST API. (created 2026-01-17) (completed 2026-01-17: схема маршрутов и политики в PLAN.md)
- [x] Описать границы Kafka событий и gRPC вызовов между сервисами. (created 2026-01-17) (completed 2026-01-17: раздел в PLAN.md)
- [x] Настроить фронтенд (React + JS) и базовую структуру проекта. (created 2026-01-17) (completed 2026-01-17: Vite + React, базовые зависимости, структура)
- [x] Собрать UI для экранов: логин/регистрация/восстановление, каталог, карточка товара, корзина, заказы, кабинет продавца, модерация. (created 2026-01-17) (completed 2026-01-17: экранные маршруты и UI реализованы)
- [x] Подключить API интеграции (auth, каталог, поиск, заказы, модерация, уведомления, метрики). (created 2026-01-17) (completed 2026-01-17: добавлены API-клиенты и интеграции)
- [x] Обернуть фронтенд в Docker (dev/prod). (created 2026-01-17) (completed 2026-01-17: Dockerfile + nginx, сервис в docker-compose)
- [x] Обновить визуальный стиль фронтенда на современный. (created 2026-01-18) (completed 2026-01-18: обновлены глобальные стили и компоненты UI)
- [x] Открыть CORS для фронтенда. (created 2026-01-18) (completed 2026-01-18: разрешены localhost:3000/5173 с preflight)
- [x] Добавить имя и дату рождения при регистрации. (created 2026-01-18) (completed 2026-01-18: поля добавлены в домен, БД, API и UI)
- [x] Исправить артефакты в UI авторизации и сообщения об ошибках. (created 2026-01-18) (completed 2026-01-18: обновлены тексты и маппинг кодов ошибок)
- [x] Сбрасывать сессию при невалидном refresh-токене. (created 2026-01-18) (completed 2026-01-18: проверка refresh при старте и logout при ошибке)
- [x] Смягчить инициализацию индекса Elasticsearch при старте. (created 2026-01-18) (completed 2026-01-18: старт без падения при недоступном ES)
- [x] Исправить некорректные тексты в UI. (created 2026-01-18) (completed 2026-01-18: тексты на русском в основных экранах)
